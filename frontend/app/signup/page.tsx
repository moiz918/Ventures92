      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '440px' }}>
          ...
          >
            Join Pakistan's
            <br />
            <span style={{ color: '#C9A84C' }}>Premier</span>
            <br />
            Real Estate Portal
          </h2>
          <p
          ...
          >
            Get access to verified listings, curated portfolios, and
            dedicated agents — all in one place.
          </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '8px' }}>
            {[
              ...
              'Verified properties, zero surprises',
            ...
            <div style={{ position: 'relative' }}>
              <span
                style={{
                  ...
                  color: isFocused('email') ? '#C9A84C' : '#4d4637',
              ...
              <input
                ...
                style={{ ...inputStyle(isFocused('email')), paddingLeft: '42px' }}
              />
            </div>
          </div>
            ...
            <div style={{ position: 'relative' }}>
              <span
                style={{
                  ...
                  top: '50%',
                  transform: 'translateY(-50%)',
                  color: isFocused('password') ? '#C9A84C' : '#4d4637',
                  transition: 'color 0.15s',
                  pointerEvents: 'none',
                  display: 'flex',
                }}
            ...
            <div style={{ position: 'relative', flexShrink: 0, marginTop: '1px' }}>
              <input
                ...
                style={{
                  ...
                  width: '16px',
                  height: '16px',
                  border: `1px solid ${agreed ? '#C9A84C' : '#4d4637'}`,
                  backgroundColor: agreed ? 'rgba(201,168,76,0.15)' : '#100e08',
                  cursor: 'pointer',
